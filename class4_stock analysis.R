...
# What is AAPL?
class(AAPL) #ts (timeframe series) used to create data in series i.e. only regular - no break in between. But in stocks we have holidays in between and each day as well we different values. so xtx and zoo are used
head(AAPL)
tail(AAPL)
