...
inspect(subset1)
inspect(rules2)
subset2 = subset(rules2, subset=lhs %ain% c('baking powder','soda') ) # ain - all items in the rule (both should be there)
inspect(subset2)
subset2a = subset(rules2, subset=lhs %in% c('baking powder','soda') ) # in - either of the two - baking powder or soda
inspect(subset2a)
