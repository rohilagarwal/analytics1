...
#Model
tree1 = rpart(Sales ~ . , data=data, method='anova' ) # sales ~ . is to select all the columns except sales. anything before tilde (~) becomes dependent variable and later becomes independent
tree1
