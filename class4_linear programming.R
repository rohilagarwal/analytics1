...
lprecF1 <- make.lp(0, 2) # 0 is zero constraint, 2 is no. of variables. 
lprecF1
#Profit :: 150A + 200B
set.objfn(lprecF1, c(150, 200)) # first we set the objective function i.e. result 
lprecF1
#Change from min to max problem
lp.control(lprecF1, sense="max") # by default, it is set at 'min.'
lprecF1
